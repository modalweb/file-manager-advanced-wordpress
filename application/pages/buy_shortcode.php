...
<p><strong><?php _e('Congratulations,','file-manager-advanced')?> </strong><?php _e('You have Installed File Manager Advanced Shortcode Succcessfully. Start working with shortcode.','file-manager-advanced')?></p><button type="button" class="notice-dismiss"><span class="screen-reader-text">Dismiss this notice.</span></button>
</div>
<?php } else { ?>
<div id="setting-error-settings_updated" class="error settings-error notice is-dismissible"> 
<p><strong><?php _e('PRO,','file-manager-advanced')?> </strong><?php _e('Please Install <a href="http://modalwebstore.com/product/file-manager-advanced-shortcode/" target="_blank">File Manager Advanced Shortcode</a> Plugin to make shortcode work. <a href="http://modalwebstore.com/product/file-manager-advanced-shortcode/" target="_blank" class="button button-primary">Install Now</a>','file-manager-advanced')?></p>
</div>
<?php } ?>
<p><code>[file_manager_advanced login="yes" roles="author,editor,administrator" path="wp-content" hide="plugins" operations="mkdir,download" block_users="1,5" view="grid" theme="light" lang ="en"]</code></p>
<h3>Parameters: </h3>
...
<td><code>[file_manager_advanced login="yes" roles="author,editor,administrator" path="wp-content/uploads" path_type="inside"]</code></td>
</tr>
<tr>
<td>hide</td>
<td>plugins</td>
...
<tr>
<td>operations</td>
<td>all / mkdir, mkfile, rename, duplicate, paste, ban, archive, extract, copy, cut, edit, rm, download, upload, search, info, help, empty</td>
